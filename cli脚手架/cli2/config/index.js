...
module.exports = {
  dev: {  //开发环境下的配置
    ...
    proxyTable: {},   //在这里使用代理解决跨越问题


    // Various Dev Server settings
    host: 'localhost', // can be overwritten by process.env.HOST  // 域名
    port: 8080, // can be overwritten by process.env.PORT, if port is in use, a free one will be determined // 开启的端口号，默认是8080
  ...
  build: {  //生产发环境下的配置
    ...
    index: path.resolve(__dirname, '../dist/index.html'),  //index.html编译后生成的位置和名字
