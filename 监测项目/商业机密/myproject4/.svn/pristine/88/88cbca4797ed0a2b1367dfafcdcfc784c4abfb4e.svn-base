...
export function deleteItem(params) {
  return request({
    url: 'monitor/cross-special-apply/' + params,
    method: 'delete'
  })
}
// 新增线索分析
...
export function clue(params) {
  return request({
    url: 'monitor/cross-special-apply',
    method: 'post',
    data: params
  })
}
...
export function save(params) {
  return request({
    url: 'monitor/cross-special-apply/saveApply',
    method: 'post',
    data: params
  })
}
...
export function statistics(params) {
  return request({
    url: 'monitor/cross-special-apply/total',
    method: 'get',
    params: params
  })
}
...
export function approvalStaus(specialApplyDO, workflow) {
  return request({
    url: 'monitor/cross-special-apply/specialApply',
    method: 'post',
    data: {
...
export function updateForm(specialApplyDO, workflow) {
  return request({
    url: 'monitor/cross-special-apply/update',
    method: 'put',
    data: {
      specialApplyDO: specialApplyDO,
      workflow: workflow
