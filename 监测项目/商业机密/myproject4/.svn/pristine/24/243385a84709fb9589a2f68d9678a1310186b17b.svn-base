  ...
  <div class="forewarningRule_add">
    <el-card>
      ...
      <div class="searchBlock">
        <el-form :model="searchBlock" label-width="114px" ref="addForm" :rules="formRules">
          <el-row :gutter="20">
            <el-col :span="12">
              <el-form-item label="规则名称" prop="ruleName">
                <el-input v-model="searchBlock.ruleName" placeholder="请输入规则名称，最长字符为50字符" maxlength="50"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="预警程度" prop="wornLevel">
                <el-select v-model="searchBlock.wornLevel" clearable placeholder="请选择" style="width:100%;">
          ...
          <el-row :gutter="20">
            <el-col :span="12">
              <el-form-item label="预警周期">
                <!-- <el-select v-model="searchBlock.wornCycle" clearable placeholder="请选择" disabled="disabled" style="width:100%;">
            ...
            <el-col :span="12">
              <el-form-item label="监测周期" prop="monitorCycle">
                <el-date-picker value-format="yyyy-MM-dd" v-model="searchBlock.monitorCycle" type="daterange" unlink-panels range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期" :picker-options="pickerOptions" style="width:100% !important;">
                </el-date-picker>
              </el-form-item>
            </el-col>
            <!-- <el-col :span="24">
        ...
        <div class="btnBottom" style="textAlign:center">
          <el-button type="primary" :loading='loading' @click="addRule('item')">保 存</el-button>
  ...
  methods: {
    ...
    addRule(formName) {
      if (this.$refs.tree) {
        ...
        console.log(this.searchBlock.listWarnRangeDO)
      }
              ...
              if (this.$route.query.id) {
                ...
                updateRule(obj).then(res => {
                  if (res.code === 200) {
                    ...
                    this.$router.push({ name: 'advancedForewarningRule' })
                  } else {
                    this.loading = false
                  }
                }).catch(() => {
