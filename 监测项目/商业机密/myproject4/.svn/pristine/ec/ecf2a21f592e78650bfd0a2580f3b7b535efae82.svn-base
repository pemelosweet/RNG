        ...
        >
          ...
          <el-table-column label="操作" width="300" fixed="right">
            <template slot-scope="scope">
              ...
              <el-button type="text" :disabled="scope.row.orState !=='0'"  @click="deleteInfo(scope.row)">删除查询结果</el-button>
            </template>
          </el-table-column>
        </el-table>
        <el-pagination
...
import { getList } from '@/api/sys-monitoringAnalysis/resultExportJian/index'
