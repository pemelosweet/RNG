  ...
  <div class="establishDataInfo">
    ...
    <el-form ref="formModeling" :model="formModeling" :rules="formModelingRules"  label-width="140px">
      ...
      <el-form-item class="valable">
        ...
        <el-button @click="clearForm" plain>清空</el-button>
      </el-form-item>
    </el-form>
     <div class="titlefix">
    ...
    <el-table :data="tableData"
      ...
      <el-table-column prop="dsName" label="数据模板名称" width="270" show-overflow-tooltip>
   ...
   <!-- 人工上传预览数据 -->
          ...
          <el-table-column align="center" v-for="(item,index) in this.previewTableData.tableName" :key="index" :label="item" show-overflow-tooltip>
            <template slot-scope="scope">
               <el-popover trigger="hover" placement="top">
                    ...
                    <div slot="reference" class="name-wrapper">
                            <el-button type="text">{{previewTableData.dataPreviewArr[scope.$index][index]}}</el-button>
                    </div>
                </el-popover>
            </template>
          </el-table-column>
    ...
    <!-- 模板详情 -->
    <el-dialog title="数据类别：交易数据" :visible.sync="modelDialogVisible" width="60%" top="2vh">
...
<script>
import { commonPattern, isValidInput, delDataValidInput } from '@/utils/formValidate.js'
import {
  searchModeling1,
  dataAllDeletes,
  previewData,
