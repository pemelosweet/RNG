  ...
  <div class="m-complete-handle">
          ...
          <el-row>
            ...
            <el-col :span="6">
                <el-form-item label="跨境协查申请">
                  <template>
                    <span>(共计：{{alreadyForm.crossbrApply}})</span>
                  </template>
                </el-form-item>
            </el-col>
          </el-row>
    ...
    <el-row>
      <el-col :span="24" style="text-align: right;">
        <el-form :model="form" ref="searchForm" :rules="searchRules" inline>
    ...
    fetchData() {
      ...
      tallPlatform(this.objInfo).then(res => {
        if (res.code === 200) {
          ...
          this.alreadyForm.crossbrApply = res.data.crossbrApply ? res.data.crossbrApply : '0'
