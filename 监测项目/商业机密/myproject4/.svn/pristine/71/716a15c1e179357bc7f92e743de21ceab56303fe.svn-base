    ...
    <div>
      <el-tabs v-model="activeName" @tab-click="handleClick">
        ...
        <el-tab-pane label="业务表单" name="tabForm">
          <span>表单：</span>
            <el-radio-group v-model="fileType">
              <el-radio v-if="fileType === 0 || routefileType === '4'" :label="0">协查请求函</el-radio>
              <el-radio v-if="fileType === 1 || routefileType === '4'" :label="1">价值反馈表</el-radio>
              <el-radio v-if="fileType === 2 || routefileType === '4'" :label="2"> 协查反馈函</el-radio>
              <el-radio v-if="fileType === 3 || routefileType === '4'" :label="3">通报</el-radio>
            </el-radio-group>
          <div class="divider divider-dashed"></div>
          <businessForm v-show="fileType===0"  :myarr="businessFormArr"  :businessFormData="businessFormData" ref="refBusiness"></businessForm>
          <CollaborativeForm v-show="fileType===1" :collaborativeFormData="collaborativeFormData" ref="refCollaborativeForm"></CollaborativeForm>
          <feedbackForm v-show="fileType===2" :feedbackFormData="feedbackFormData" ref="refFeedbackForm"></feedbackForm>
          <noticeForm v-show="fileType===3" :myarr="noticeFormArr"   :noticeFormData="noticeForm" ref="refNoticeForm"></noticeForm>
        </el-tab-pane>
         <el-tab-pane label="录入协查反馈函"  v-if="routefileType !== '4' && fileType===0&&this.myvalName" name="inputForm">
        ...
        <el-tab-pane
            ...
            name="valueBack"
            class="classFiles"
            v-if="routefileType !== '4' && (fileType === 2||fileType === 3)"
          >
...
export default {
    ...
    formContent: {
      handler(newVal) {
        if (newVal) {
          ...
          if (obj.workflow.readType === 'doneAndFinished') {
          ...
          //   }
          // }
          this.valStatus = obj.workflow.actDefId
          this.valName = obj.workflow.name
          this.getData(obj)
        }
      },
      deep: true
  ...
  methods: {
    ...
    getData(val) {
      ...
      if (val.TongBao && val.InvRequest && val.FeedBackGJ && val.XcFeedBack) {
        console.log(this.isDisabled)
        // 通报
        var TongBaoData2 = Object.assign({}, val.TongBao, val.TongBao.subjectList[0])
        TongBaoData2.subjectList = TongBaoData2.subjectList.slice(1, TongBaoData2.subjectList.length)
        ...
        // 协查请求函
        var InvRequestData2 = Object.assign({}, val.InvRequest, val.InvRequest.subjectList[0])
        InvRequestData2.subjectList = InvRequestData2.subjectList.slice(1, InvRequestData2.subjectList.length)
    ...
    newparams() {
      ...
      const obj = {
        ...
        fileType: this.routefileType,
        mailId: this.form.fhId,
        updateFlag: '0'
      }
      switch (this.routefileType) {
        case '0': // 协查请求函
        ...
        case '2': //  协查反馈函
          ...
          break
        case '3': // 通报
          var child = JSON.parse(JSON.stringify(this.$refs.refCollaborativeForm.collaborativeForm))
    ...
    getFilelist() {
      ...
      //   case 0: // 协查请求函
      getFilelistApi(this.form.fhId).then(res => {
