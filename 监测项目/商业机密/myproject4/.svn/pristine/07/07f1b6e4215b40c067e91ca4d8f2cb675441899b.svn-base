<template>
  <div class="reportingManagement_information">
    <el-card>
      ...
      <el-form ref="form" :model="form" :rules="searchRules" label-width="150px">
        <el-row :gutter="20">
          <el-col :span="8">
            <el-form-item label="举报编号：" prop="reportNo">
              <el-input v-model="form.reportNo"></el-input>
            </el-form-item>
            <el-form-item label="被举报人证件号码：" prop="reportedCredNo">
          ...
          <el-col :span="8">
            ...
            <el-form-item label="被举报人名称：" prop="reportedName">
              <el-input v-model="form.reportedName"></el-input>
            </el-form-item>
            <el-form-item label="账号：" prop="reportedAccountNo">
            ...
            <el-form-item label="标签：" prop="reporterMark">
...
export default {
  data() {
    return {
      ...
      isDisBtn: '',
      searchRules: {
        reportNo: [{ validator: isValidInputBuZheng, trigger: 'blur' }],
        reportedCredNo: [{ validator: isValidInputBuZheng, trigger: 'blur' }],
        reportedName: [{ validator: isValidInputBuZheng, trigger: ['blur', 'change'] }],
        reportedAccountNo: [{ validator: isValidInputBuZheng, trigger: ['blur', 'change'] }],
        reporterMark: [{ validator: isValidInputBuZheng, trigger: ['blur', 'change'] }]
      }
    }
  },
  mounted() {
