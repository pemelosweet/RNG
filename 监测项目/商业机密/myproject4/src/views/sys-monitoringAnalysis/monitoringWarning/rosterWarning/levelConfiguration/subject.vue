<template>
  <div class="rosterWarning_levelConfiguration">
     <el-form :model="searchform"  ref="searchForm" :rules="searchRules" label-width="140px" >
          <el-row>
           <el-col :span="8">
              <el-form-item  label="主体类型"  prop="codeName">
            <el-input clearable v-model="searchform.codeName" maxlength="30" placeholder="主体类型"></el-input>
          </el-form-item>
           </el-col>
      ...
      <el-table style="width: 100%;margin-top:20px" :data="tableData">
          ...
          <el-table-column prop="codeName" label="主体类型" min-width="110"></el-table-column>
      ...
      <el-dialog title="编辑" :visible.sync="dialogFormVisible">
        <el-form :rules="rules" :model="form" ref="form">
          ...
          <el-form-item label="主体类型" :label-width="formLabelWidth" prop="codeName">
            <el-input maxlength="30" clearable v-model="form.codeName" placeholder="主体类型"></el-input>
          </el-form-item>
  ...
  methods: {
    ...
    exportExcel() {
      if (this.tableData.length > 0) {
        location.href = `/monitor/listwarn/sensitive/outFile/2?token=${this.token}`
      } else {
        this.$message({
          message: '列表为空无法导出',
          type: 'warning',
