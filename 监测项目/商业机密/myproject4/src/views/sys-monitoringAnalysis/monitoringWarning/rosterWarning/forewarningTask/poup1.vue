  ...
  data() {
    return {
      ...
      rules: {
        ...
        accNum: [{ validator: this.onlyNumberValidate1, trigger: 'blur' }, { validator: ValidQueryInput, trigger: 'blur' }],
        subjectINum: [{ max: 128, validator: this.onlyNumberValidate, trigger: 'blur' }, { validator: ValidQueryInput, trigger: 'blur' }]
      }
    }
  },
  computed: {
    ...
    certificate() {
      switch (this.dialogForm.subjectIType) {
        ...
        case '110001':
          ...
          break
        case '':
          this.rules.subjectINum = [{ validator: this.onlyNumberValidate, trigger: 'blur' }, { validator: ValidQueryInput, trigger: 'blur' }]
          break
        default:
          this.rules.subjectINum = [{ max: 128, validator: this.onlyNumberValidate, trigger: 'blur' }, { validator: ValidQueryInput, trigger: 'blur' }]
          break
      }
    }
  }
