      ...
      <div class="taleBlock">
        ...
        <el-table :data="tableData" tooltip-effect="dark" @selection-change="handleChange">
          ...
          <el-table-column  label="操作" min-width="200" fixed="right">
            <template slot-scope="scope">
              <el-button
               v-if="!director && scope.row.reportAudit.reviewOpinion"
              ...
              <el-button
               v-if="!director && !scope.row.reportAudit.reviewOpinion"
              :disabled="!((scope.row.reportAnalyze.analyseOpinion=='中心-移送'||scope.row.reportAnalyze.analyseOpinion=='中心-通报'||scope.row.reportAnalyze.analyseOpinion=='中心-继续关注') && scope.row.clewState==='已审核')"
                type="text"
                @click="Initiate1(scope)"
              >发起移送流程</el-button>
