    ...
    <el-card>
      <div slot="header">
        ...
        <div class="headerTip" style="float:right">
          <span v-if="this.isBranch">分支机构：{{this.sss}}</span>
      ...
      <!-- {{this.form}} -->
      <!-- {{hxId}} -->
      <!-- {{this.$route.query.pageFlag !== 'new'}} -->
      <el-form ref="validForm" :rules="rules" :model="form" :disabled="this.$route.query.fenxiIndex === '0' || nameListXTF.typeXTF === 'typeXTF'">
          ...
          <div class="itemBlock" v-if="!this.greys">
            ...
            <div class="dataList">
              <el-table :data="form.IDCardData" style="width: 100%;">
                ...
                <el-table-column label="主体/对手" width="160">
                  <template slot-scope="scope">
                    <el-form-item
                ...
                <el-table-column label="操作" width="80px" v-if="!this.greys">
                  <template slot-scope="scope">
                    <el-button type="text" @click="delIdentity(scope.$index,scope.row.tradeId)">删除</el-button>
                  </template>
                </el-table-column>
              </el-table>
            </div>
          ...
          <div class="itemBlock" v-if="!this.greys">
            ...
            <div class="dataList">
              <el-table :data="form.accountData">
                ...
                <el-table-column label="操作" width="80px" v-if="!this.greys">
                  <template slot-scope="scope">
                    <el-button type="text" @click="delAccount(scope.$index,scope.row.tradeId)">删除</el-button>
                  </template>
                </el-table-column>
              </el-table>
            </div>
            ...
            <div class="dataList">
              <el-table :data="form.IDCardData">
                ...
                <el-table-column label="操作" width="80px">
                  <template slot-scope="scope">
                    <el-button disabled type="text" @click="delIdentity(scope.$index,scope.row.tradeId)">删除</el-button>
                  </template>
                </el-table-column>
              </el-table>
            </div>
          ...
          <div class="itemBlock" v-if="this.greys">
            ...
            <div class="dataList">
              <el-table :data="form.accountData">
                ...
                <el-table-column label="操作" width="80px">
                  <template slot-scope="scope">
                    <el-button type="text" disabled @click="delAccount(scope.$index,scope.row.tradeId)">删除</el-button>
                  </template>
                </el-table-column>
              </el-table>
            </div>
        ...
        <div
          class="block"
          v-if="(this.sbypxsId.type!=='xtfZiZhu' && analysisHide&&(this.isCenter||((this.isBranch&&this.form.isvisible==='1')&&this.form.isvisible==='1')))"
        >
          <el-row class="blckTitle">
            <el-col :span="12">
              <span>分析研判意见</span>
        ...
        <div
          class="block"
          v-if="(this.sbypxsId.type!=='xtfZiZhu' &&auditorHide&&(this.isCenter||(this.isBranch&&this.form.isvisible==='1')))||(form.clewState==='待审核'&&this.isCenter)"
        >
          <el-row class="blckTitle">
            <el-col :span="12">
              <span>审核意见</span>
        ...
        <div
          class="block"
          v-if="this.sbypxsId.type!=='xtfZiZhu' &&transferHide&&((this.isCenter&&(form.clewState==='已移送'||form.clewState==='仅报告'||form.clewState==='不予立案'||form.clewState==='立案'||form.clewState==='结案'||form.clewState==='撤案'||form.reviewOpinion==='15'))||(this.isBranch&&this.form.isvisible==='1'&&(form.reviewOpinion==='10'||form.reviewOpinion==='11'||form.reviewOpinion==='12'||form.reviewOpinion==='15'||form.clewState==='已移送'||form.clewState==='仅报告'||form.clewState==='不予立案'||form.clewState==='立案'||form.clewState==='结案'||form.clewState==='撤案')))"
        >
          <el-row class="blckTitle">
            <el-col :span="12">
              <span>移送情况</span>
              ...
              <el-button  v-if="((this.isBranch&&this.form.isvisible==='1'&&(form.reviewOpinion==='10'||form.reviewOpinion==='11'||form.reviewOpinion==='12'||form.reviewOpinion==='15'))&&this.signs&&ysbtn&&form.clewState!=='已审核')||
          (this.isCenter&&(form.reviewOpinion==='15'||form.reviewOpinion==='0'||form.reviewOpinion==='1'||form.reviewOpinion==='2')&&ysbtn&&form.clewState!=='已审核')" @click="updateAsh" >修 改</el-button>
               <el-button   :loading="loads" v-if="((this.isBranch&&this.form.isvisible==='1'&&(form.reviewOpinion==='10'||form.reviewOpinion==='11'||form.reviewOpinion==='12'||form.reviewOpinion==='15'))&&this.signs&&!ysbtn&&form.clewState!=='已审核')||
          (this.isCenter&&(form.reviewOpinion==='15'||form.reviewOpinion==='0'||form.reviewOpinion==='1'||form.reviewOpinion==='2')&&!ysbtn&&form.clewState!=='已审核')" @click="SaveAsh('validForm')" >保 存</el-button>
            </el-col>
          </el-row>
          <div class="itemBlock">
            <el-row :gutter="20">
            ...
            <el-row :gutter="20">
              ...
              <el-col :span="12">
                <el-form-item label="交易发生地：" label-width="220px" prop="ysdistrict">
                  <el-input
                    :disabled="this.ysAsh"
        ...
        <div class="block" v-if=" this.sbypxsId.type!=='xtfZiZhu' &&followHide&&((this.form.isvisible==='1'&&this.isBranch&&((form.clewState!=='已移送')||form.clewState==='已移送'&& (form.reviewOpinion==='10'||form.reviewOpinion==='11'||form.reviewOpinion==='12'||form.reviewOpinion==='15')))||this.isCenter&&((form.clewState!=='已移送')||form.clewState==='已移送'&&((form.reviewOpinion==='15'||form.reviewOpinion==='0'||form.reviewOpinion==='1'||form.reviewOpinion==='2'))))">
          <el-row class="blckTitle">
            <el-col :span="12">
              <span>后续办理情况</span>
            </el-col>
             <el-col :span="12" style="text-align: right;">
              <el-button v-if="((this.isBranch&&this.form.isvisible==='1'&&
              (form.reviewOpinion==='10'||form.reviewOpinion==='11'||form.reviewOpinion==='12'||form.reviewOpinion==='15'))
              &&this.signs&&hxbtn&&form.clewState!=='已移送')
              ||(this.isCenter&&(form.reviewOpinion==='15'||form.reviewOpinion==='0'||form.reviewOpinion==='1'||form.reviewOpinion==='2')&&hxbtn&&form.clewState!=='已移送')"  @click="updateHx" >修 改</el-button>


               <el-button :loading="loads"  v-if="((this.isBranch&&this.form.isvisible==='1'&&
              (form.reviewOpinion==='10'||form.reviewOpinion==='11'||form.reviewOpinion==='12'||form.reviewOpinion==='15'))
              &&this.signs&&!hxbtn&&form.clewState!=='已移送')
              ||
          (this.isCenter&&(form.reviewOpinion==='15'||form.reviewOpinion==='0'||form.reviewOpinion==='1'||form.reviewOpinion==='2')&&!hxbtn&&form.clewState!=='已移送')"  @click="SaveHx('validForm')" >保 存</el-button>
            </el-col>
          </el-row>
          <div class="itemBlock">
            <el-row :gutter="20">
              <el-col :span="24">
                <!-- <el-form-item label="涉罪类型：" label-width="160px" prop="crimeType">
                  <el-select
                ...
                <div>
                  ...
                  <!-- <preliminary-judgment
                    ...
                    :judgmentInp1="judgmentInp1"
                    :judgmentInp2="judgmentInp2"
                    @judgment="getJudgment3"
                    :echoJudgment="reportCluePreJudgment3"
                    @judgmentOther="getJudgmentOther"
                  ></preliminary-judgment>-->
                </div>
              </el-col>
            ...
            <!-- <el-row :gutter="20">
              <el-col :span="24">
                <el-form-item label="涉罪类型其他输入项：" label-width="160px">
                  <el-input v-model="form.crimeTypeOther" placeholder></el-input>
                </el-form-item>
              </el-col>
            </el-row>-->
            <el-row :gutter="20">
              <el-col :span="8">
                <el-form-item
                  ...
                  label-width="160px"
                  prop="register"
                  :rules="[{ required: isRegister,validator: isValidInputLIAN, trigger: 'blur' }]"
                >
                  <el-input
                  :disabled="(this.hxAsh||((this.isBranch&&(form.reviewOpinion==='0'||form.reviewOpinion==='1'||form.reviewOpinion==='2'))||
                      (this.isCenter&&(form.reviewOpinion==='10'||form.reviewOpinion==='11'||form.reviewOpinion==='12'))))"
              ...
              <el-col :span="8">
                <el-form-item
                  ...
                  label-width="160px"
                  prop="caseNote"
                  :rules="[{ required: isDetection, validator: isValidInputJIEAN, trigger: 'blur' }]"
                >
                  <el-input
                  :disabled="(this.hxAsh||((this.isBranch&&(form.reviewOpinion==='0'||form.reviewOpinion==='1'||form.reviewOpinion==='2'))||
                      (this.isCenter&&(form.reviewOpinion==='10'||form.reviewOpinion==='11'||form.reviewOpinion==='12'))))"
            ...
            <el-form-item label="交办方向：" label-width="160px"  :rules="[{validator: isValidInput22, trigger: 'blur'}]"
              prop="handDirection">
              <el-input
            ...
            <el-form-item label="附件： " label-width="160px">
              ...
              :disabled="(this.hxAsh||((this.isBranch&&(form.reviewOpinion==='0'||form.reviewOpinion==='1'||form.reviewOpinion==='2'))||
                ...
                :on-remove="handleRemove"
                 :on-error ="errorFile"
              >
                <el-button type="text"  :disabled="(this.hxAsh||((this.isBranch&&(form.reviewOpinion==='0'||form.reviewOpinion==='1'||form.reviewOpinion==='2'))||
                      (this.isCenter&&(form.reviewOpinion==='10'||form.reviewOpinion==='11'||form.reviewOpinion==='12'))))">添加附件</el-button>
              </el-upload>
            </el-form-item>
          </div>
        </div>
      ...
      <div class="saveBtn" v-if="!(sbypxsId.type==='xtfZiZhu')">
        <!-- 申请保存按钮 -->
        <el-button
          :loading="loads"
          type="primary"
        ...
        <el-button
          ...
          v-if="(form.clewState==='已审核'&&(this.isBranch&&this.form.isvisible==='1'&&(form.reviewOpinion==='10'||form.reviewOpinion==='11'||form.reviewOpinion==='12'||form.reviewOpinion==='15'))&&this.signs)||
...
export default {
  ...
  data() {
    ...
    return {
      ...
      rules: {
        ...
        initJudge2: [{ type: 'array', message: '请至少选择一个类型', trigger: 'change' }],
        // 后续办理验证
        // followForm: {
        ...
        // 移送情况验证
        ysdistrict: [{ message: '请输入交易发生地', trigger: 'blur' }],
        // crimeType: [{ required: true, message: '请选择涉罪类型', trigger: 'blur' }],

        // 联系人验证
        createUser: [{ required: true, validator: spaceBarAndSpecial, trigger: 'blur' }],
        // createUserTel: [{ required: true, validator: this.onlyNumberValidate1, trigger: 'blur' }],
        auditingUser: [{ required: true, validator: spaceBarAndSpecial, trigger: 'blur' }]
  ...
  methods: {
    ...
    getBranch() {
      branch({ typeId: 'FZJGD' }).then(res => {
        if (res.code === 200) {
          ...
          this.localBankArr.forEach(el => {
            if (el.codeId === this.user_riid) {
              this.sss = el.codeName
              console.log(el.codeName)
            }
          })
        }
      })
      ...
      this.$refs[formName].validate(valid => {
        if (valid) {
          const submitObj = {
            ...
            cart: this.form.cart,
            reportDate: this.form.reportDate ? this.form.reportDate : '',
            registerTime: this.form.registerTime ? this.form.registerTime : '',
          ...
          this.loads = true
          setTimeout(() => {
            FollowUpdate(submitObj).then(res => {
              if (res.code === 200) {
                this.loads = false
    ...
    updateAsh() {
      this.ysbtn = false
      this.ysAsh = false
      console.log(this.ysAsh, '22222222')
    },
    forAsh(...arg) {
      var formName = arg[0]
      var argArr = []
      ...
      return step === argArr.length - 1
    },
    SaveAsh(formName) {
      // this.$refs[formName].validate(valid => {
      // if (valid) {
      var fieldFlag = this.forAsh(formName, 'transferDirection', 'transferNumber', this.isReplenishOne2 ? 'supplementOne2' : '', this.isReplenishTwo2 ? 'supplementTwo2' : '')
      if (fieldFlag) {
        const submitObj = {
        ...
        this.loads = true
        setTimeout(() => {
          TransferUpdate(submitObj).then(res => {
            if (res.code === 200) {
              this.loads = false
    ...
    isValidInputJIEAN(rule, value, callback) {
      if (!commonPattern.spaceBar.test(value)) {
        callback(new Error('内容不能含有空格'))
      } else if (commonPattern.specialChar.test(value) || commonPattern.specialEng.test(value)) {
        callback(new Error('内容不能填写特殊字符'))
      } else if ((value === '' || value === undefined) && this.isDetection) {
        callback(new Error('案件侦破情况不能为空'))
      } else {
        callback()
      }
    },
    isValidInputLIAN(rule, value, callback) {
      if (!commonPattern.spaceBar.test(value)) {
        callback(new Error('内容不能含有空格'))
      } else if (commonPattern.specialChar.test(value) || commonPattern.specialEng.test(value)) {
        callback(new Error('内容不能填写特殊字符'))
      } else if ((value === '' || value === undefined) && this.isRegister) {
        callback(new Error('立案名目不能为空'))
      } else {
        callback()
      }
    },
    ...
    getCountry() {
      country().then(res => {
        ...
        if (res.code === 200) {
          ...
          //   // 香港为344  满足去掉接下来的3个（香港 澳门 台湾）
          //   if (el.numCode === '344') {
          //     res.data.list.splice(index, 3)
          //   }
          // })
    ...
    // 表单回显
    getDetail() {
      if (this.sbypxsId.type === 'xtfZiZhu') {
        this.greys = true
        getList(this.sbypxsId.id)
          .then(res => {
            if (res.code === 200) {
              ...
              submitObj.deptOpinion = data.deptOpinion
      ...
      } else if (this.nameListXTF.typeXTF === 'typeXTF') {
        this.greys = true
        getList(this.nameListXTF.id)
          .then(res => {
            if (res.code === 200) {
              const data = res.data.reportLeadsList[0]
              const submitObj = {}
        ...
        const clueId = this.$route.query.fenxiIndex === '0' ? this.$route.query.sbypxsId : this.$route.params.id
        this.chooseId = clueId
        const clewStates = this.$route.params.clewStates
        if (clueId) {
          this.id = clueId
          this.idFiles = clueId
