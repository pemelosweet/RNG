<template>
  <div class="judgedClues_subsequent">
    <el-card>
      <div slot="header">
        <span>人民银行分支机构机上报分析申请 - 后续办理情况</span>
            ...
            <el-row :gutter="20">
              ...
              <el-col :span="8">
                <el-form-item label="涉案金额：" label-width="140px">
                  <el-input v-model="formCommon.sum" placeholder=""></el-input>
                </el-form-item>
              </el-col>
            </el-row>
      ...
      <div class="saveBtn" style="paddingTop:20px">
        ...
        <router-link :to="{name:'judgedClues_subsequent_subsequentAdd'}">
          <el-button type="primary" plain>添加后续办理情况</el-button>
        </router-link>
        <router-link :to="{name: 'judgedClues_subsequent_subsequentHistory'}">
          <el-button type="primary" plain>查看后续办理情况</el-button>
        </router-link>
