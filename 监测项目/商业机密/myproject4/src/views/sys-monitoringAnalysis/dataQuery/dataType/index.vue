            ...
            <div v-for="(client,cIndex) in item" :key="cIndex" label-width="120px">
              ...
              <el-col :span="client.ttConditionColumn.qttccName === '主体名称'? 16 : 8" v-if="client.ttConditionColumn.qttccType === 1 && client.ttConditionColumn.qttccName !== '主体类型'">
                <el-form-item :label="client.ttConditionColumn.qttccName" :rules="clientRule(item, cIndex)" :prop="'clientInfo.'+index+'.'+cIndex+'.qttcVal'" style="height: 34px;">
                  <el-input v-model="client.qttcVal" :maxlength="getInputMax(client)" :placeholder="getPlaceholder(client)" @blur="handleClientnameChange(client, index,item)" style="width: 100%;"></el-input>
                </el-form-item>
              </el-col>
...
import { isIpAddress, ValidQueryInput, delDataValidInput, onlyNumberValidate } from '@/utils/formValidate.js'
...
export default {
  ...
  methods: {
    ...
    handleClientnameChange(client, index, item) { // 填写主体名称或证件号码，主体类型是必填
    },
    handleTableList(row) {
