  ...
  element-loading-background="rgba(0, 0, 0, 0.3)">
    <el-card class="box-card">
      ...
      >
        ...
        <router-link
          style="float:right"
          :to="{name:'sendTaskInfo_add'}"
        >
          <el-button type="text">新建分析任务</el-button>
        </router-link>
      </div>
      <div class="text item">
        ...
        >
          ...
          <el-table-column label="操作" width="120" fixed="right">
            <template slot-scope="scope">
              <el-button type="text" :disabled="scope.row.status ==='2'" @click="updateInfo(scope.row)">编辑</el-button>
              <el-button type="text" :disabled="scope.row.status ==='2'" @click="deleteInfo(scope.row)">删除</el-button>
            </template>
          </el-table-column>
        </el-table>
        <el-pagination
