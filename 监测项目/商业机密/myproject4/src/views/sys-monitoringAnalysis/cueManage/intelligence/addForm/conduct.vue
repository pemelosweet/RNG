<template>
  <div class="cueManage_investigation_transfer">
    <div class="list-block">
      <el-row>
        <el-col :span="24" style="text-align:center;font-size:20px;font-weight:bold;height:60px;line-height: 60px;">
          <span>流转信息</span>
        </el-col>
      </el-row>
      <el-table :data="tableData">
        ...
        <el-table-column label="办理人" prop="department" min-width="130"></el-table-column>
        <el-table-column label="办理时间" prop="handle"></el-table-column>
        <el-table-column label="办理意见" prop="time"></el-table-column>
        <el-table-column label="备注" prop="remark"></el-table-column>
        <el-table-column label="签名" prop="idea"></el-table-column>
      </el-table>
      <el-pagination 
