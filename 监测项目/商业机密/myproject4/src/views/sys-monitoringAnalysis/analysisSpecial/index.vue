  ...
  element-loading-background="rgba(0, 0, 0, 0.3)">
    <el-card>
      ...
      >
        ...
        <router-link
          v-if="isShow"
          :to="{name:'analysisSpecial_clueSave'}"
          style="float:right"
        >
        ...
        <template v-else>
          <el-row class="toggle" :gutter="20">
            ...
            <el-col :span="8">
              <el-form-item
                label="状态："
                prop="clueState" :rules="[{ required:false, trigger: 'change'}]"
              >
                <el-select
                  clearable
          ...
          <el-row :gutter="20">
            ...
            <el-col :span="8">
              <el-form-item
                label="证件类型："
                prop="certificateType" :rules="[{ required:false, trigger: 'change'}]"
              >
                <el-select
                  clearable
          ...
          <!-- <el-col :span="8">
            ...
            <!-- <el-col
              ...
              v-if="textInp"
            > -->
              <el-form-item   label="专项类别："  prop="text">
                <el-input
                @input="changeInput"
                  v-model="form.text"
      ...
      <el-table :data="tableData">
        ...
        <el-table-column label="线索名称" show-overflow-tooltip>
          <template slot-scope="scope">
            <router-link :to="{name:'analysisSpecial_clueSave',query: { id: scope.row.applyId, type: scope.row.clueState}}">
        ...
        <el-table-column label="操作" v-if="!disabled">
          <template slot-scope="scope">
            <!-- <router-link :to="{name:'analysisSpecial_clueSave',query: { id: scope.row.applyId}}"> -->
...
import { branch, research, deleteItem } from '@/api/sys-monitoringAnalysis/analysisSpecial/index.js'
