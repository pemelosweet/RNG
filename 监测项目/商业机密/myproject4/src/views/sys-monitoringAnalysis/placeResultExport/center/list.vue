        ...
        >
          ...
          <el-table-column label="操作" width="300" fixed="right">
            <template slot-scope="scope">
              ...
              <el-button type="text"  :disabled="scope.row.downStatus ==='0'"  @click="downloadInfo(scope.row)">下载查询结果</el-button>
              <el-button type="text" :disabled="scope.row.assistState !=='0'"  @click="deleteInfo(scope.row)">删除查询结果</el-button>
            </template>
          </el-table-column>
        </el-table>
        <el-pagination
...
import { getList } from '@/api/sys-monitoringAnalysis/placeResultExport/index'
